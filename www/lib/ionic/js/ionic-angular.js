 ...
 * @module ionic
 * @description
 * Ionic automatically takes platform configurations into events to adjust things like what
...
function RepeatManagerFactory($rootScope, $window, $$rAF) {
  ...
  return function RepeatController(options) {
    ...
    this.refreshLayout = function() {
      ...
      // into events where to position itself relative to the previous element's marginBottom.
    ...
    function StaticViewType() {
      ...
      this.updateRenderRange = function(scrollValue, scrollValueEnd) {
        ...
        // Make sure the renderEndIndex takes into events all the items on the row
